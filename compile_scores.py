...
Example:
    python3 compile_scores.py npm_top_10k/Analysis
...
For each package directory <analysis_root>/<pkg>/, this script:
  ...
  - Computes:
        ...
        * total package size in bytes (all files under the pkg dir)
  - Writes per-package:
...
def process_single_package(pkg_dir: str):
    """
...
def main():
    ...
    for entry in pkg_entries:
        ...
        per_pkg_totals, warnings = process_single_package(pkg_dir)
