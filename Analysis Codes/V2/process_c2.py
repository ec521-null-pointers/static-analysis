...
USAGE = f"Usage: python3 process_{FEATURE_ID}.py <C2_hits_file> [source_js_file]"
...
def get_label(hits_path: str) -> str:
    ...
    Example:
        C2_home--...--bundle_flow.js -> home--...--bundle_flow.js
    """
...
def main():
    ...
    # 2) Summary + details file: C2_2_<label>
