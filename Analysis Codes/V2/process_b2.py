...
USAGE = f"Usage: python3 process_{FEATURE_ID}.py <B2_hits_file> [source_js_file]"
...
def get_label(hits_path: str) -> str:
    """
    Strip leading 'B2_' from basename to get a per-file label.

    Example:
        B2_home--...--bundle_flow.js -> home--...--bundle_flow.js
    """
