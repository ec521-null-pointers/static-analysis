...
USAGE = f"Usage: python3 process_{FEATURE_ID}.py <C3_hits_file> [source_js_file]"
...
def get_label(hits_path: str) -> str:
    ...
    Example:
        C3_home--...--bundle_flow.js -> home--...--bundle_flow.js
    """
...
def main():
    ...
    with open(detail_out, "w", encoding="utf-8") as fout:
        ...
        fout.write(f"Source code file:  {source_path or 'N/A'}\n\n")
        ...
        fout.write(f"arg2(source_file): {source_path or 'N/A'}\n\n")
