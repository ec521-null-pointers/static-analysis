...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  createProjectBranchDataApi = (
    ...
    this.request<DataAPICreateResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches/${encodeURIComponent(branchId)}/data-api`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @secure
   */
  deleteProjectBranchDataApi = (projectId: string, branchId: string, params: RequestParams = {}) =>
   ...
   * @secure
   */
  getProjectBranchDataApi = (projectId: string, branchId: string, params: RequestParams = {}) =>
