...
# --- 1. Aesthetic Changes: Font size and Figure size (Maximized) ---
plt.rcParams.update({'font.size': 36})
fig, ax = plt.subplots(figsize=(14, 16))

# Load the merged data for "good packages"
...
# --- 4. Calculate Max Risk Level and Fractional Counts (FIXED LOGIC) ---
...
# --- 6. Final Touches ---
ax.set_title('Normalized Risk Probability Distribution (Good Packages)', fontsize=40)
...
unique_labels['Max Risk: LOW/MED/HIGH'] = ax.bar([], [], color='gray', alpha=0.15, label='Max Risk: LOW/MED/HIGH')[0] # Placeholder for background bar info

# Plot the final custom legend
ax.legend(unique_labels.values(), unique_labels.keys(), loc='center right', fontsize=28)

plt.tight_layout()
plt.savefig("normalized_analysis_s_curve_good_final.png")
